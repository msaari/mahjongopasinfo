var tinyMCEPreInit = { settings : { themes : "advanced", plugins : "safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage", languages : "fi", debug : false }, base : "http://www.mahjongopas.info/wp-includes/js/tinymce", suffix : "", query : "ver=311" };tinyMCEPreInit.start = function() {
...
class_name:"Luokka",
not_set:"-- Ei asetettu --",
clipboard_msg:"Kopioi/Leikkaa/Liitä -toiminto ei toimi Mozilla Firefoxissa.",
clipboard_no_support:"Selaimesi ei tue toimintoa, käytä sensijaan näppäimistön pikanäppäimiä.",
popup_blocked:"Selaimesi on estänyt ponnahdusikkunan, joka vaikuttaa ohjelmiston toimivuuteen. Poista ponnahdusikkunoiden esto käytöstä tältä sivulta saadaksesi graafisen muokkaimen täydellisesti käyttöön.",
invalid_data:"Virhe: Kelpaamattomat arvot on merkitty punaisella.",
more_colors:"Lisää värejä"
},
contextmenu:{
align:"Asettelu",
left:"Vasemmalle",
...
date_fmt:"%Y-%m-%d",
time_fmt:"%H:%M:%S",
insertdate_desc:"Lisää päiväys",
inserttime_desc:"Lisää aika",
months_long:"Tammikuu,Helmikuu,Maaliskuu,Huhtikuu,Toukokuu,Kesäkuu,Heinäkuu,Elokuu,Syyskuu,Lokakuu,Marraskuu,Joulukuu",
months_short:"Tam_Tammikuu_abbreviation,Hel_Helmikuu_abbreviation,Maa_Maaliskuu_abbreviation,Huh_Huhtikuu_abbreviation,Tou_Toukokuu_abbreviation,Kes_Kesäkuu_abbreviation,Hei_Heinäkuu_abbreviation,Elo_Elokuu_abbreviation,Syy_Syyskuu_abbreviation,Lok_Lokakuu_abbreviation,Mar_Marraskuu_abbreviation,Jou_Joulukuu_abbreviation",
day_long:"Sunnuntai,Maanantai,Tiistai,Keskiviikko,Torstai,Perjantai,Lauantai",
day_short:"Sun,Maa,Tii,Kes,Tor,Per,Lau"
},
print:{
print_desc:"Tulosta"
},
...
directionality:{
ltr_desc:"Vasemmalta oikealle",
rtl_desc:"Oikealta vasemmalle"
},
layer:{
insertlayer_desc:"Lue uusi taso",
forward_desc:"Liiku eteenpäin",
backward_desc:"Liiku taaksepäin",
absolute_desc:"Vaihda absoluuttinen asettelu",
content:"Uusi taso..."
},
save:{
save_desc:"Tallenna",
...
iespell:{
iespell_desc:"Suorita oikeinkirjoituksen tarkistus",
download:"ieSpell -ohjelmaa ei havaittu. Haluatko asentaa sen nyt?"
},
advhr:{
advhr_desc:"Vaakaviiva"
},
emotions:{
...
advimage:{
image_desc:"Lisää kuva / Kuvan ominaisuudet"
},
advlink:{
link_desc:"Lisää linkki / Linkin ominaisuudet"
},
xhtmlxtras:{
cite_desc:"Lainaus",
abbr_desc:"Lyhenne",
acronym_desc:"Acronym",
del_desc:"Poistaminen",
ins_desc:"Lisääminen",
attribs_desc:"Lisää/Muokkaa määrityksiä"
},
style:{
desc:"Muokkaa CSS tyyliä"
},
paste:{
paste_text_desc:"Liitä muotoilemattomana",
paste_word_desc:"Liitä Wordista",
selectall_desc:"Valitse kaikki"
},
paste_dlg:{
text_title:"Käytä CTRL+V pikanäppäintä liittääksesi tekstin. ",
text_linebreaks:"Säilytä rivinvaihdot",
word_title:"Käytä CTRL+V pikanäppäintä liittääksesi tekstin. "
},
table:{
desc:"Lisää uuden taulukon",
row_before_desc:"Lisää rivi ennen",
row_after_desc:"Lisää rivi ennen",
...
split_cells_desc:"Erota yhdistetyt solut",
...
autosave:{
unload_msg:"Muutokset häviävät mikäli poistut tältä sivulta."
},
fullscreen:{
desc:"Koko näyttö (Alt+Shift+G)"
},
media:{
desc:"Lisää upotettu media / Upotetun median ominaisuudet",
delta_width:"0",
delta_height:"0",
edit:"Muokkaa upotetun median asetuksia"
},
fullpage:{
desc:"Asiakirjan ominaisuudet"
},
template:{
desc:"Lisää ennaltamääräämätön sisältö"
},
visualchars:{
desc:"Visual control characters on/off"
},
spellchecker:{
desc:"Vaihda oikeinkirjoitus (Alt+Shift+N)",
...
no_mpell:"Ei oikeinkirjoitusvirheitä."
},
pagebreak:{
...
samp:"Mallikoodi",
dt:"Määritelmä",
dd:"Määritelmän kuvaus",
bold_desc:"Lihavointi (Ctrl / Alt+Shift + B)",
italic_desc:"Kursivointi (Ctrl / Alt+Shift + I)",
underline_desc:"Alleviivaus",
striketrough_desc:"Yliviivaus (Alt+Shift+D)",
justifyleft_desc:"Vasen tasaus (Alt+Shift+L)",
justifycenter_desc:"Keskitys (Alt+Shift+C)",
justifyright_desc:"Oikea tasaus (Alt+Shift+R)",
justifyfull_desc:"Tasaa molemmat reunat (Alt+Shift+J)",
bullist_desc:"Luettelo (Alt+Shift+U)",
numlist_desc:"Numeroitu luettelo (Alt+Shift+O)",
outdent_desc:"Lisää sisennystä",
indent_desc:"Vähennä sisennystä",
undo_desc:"Kumoa (Ctrl+Z)",
redo_desc:"Tee uudelleen (Ctrl+Y)",
link_desc:"Lisää linkki / Linkin ominaisuudet (Alt+Shift+A)",
link_delta_width:"0",
link_delta_height:"0",
unlink_desc:"Poista linkki (Alt+Shift+S)",
image_desc:"Lisää kuva / Kuvan ominaisuudet (Alt+Shift+M)",
image_delta_width:"0",
image_delta_height:"0",
cleanup_desc:"Siisti virheellinen koodi",
code_desc:"Muokkaa HTML koodia",
sub_desc:"Alaviite",
sup_desc:"Yläviite",
hr_desc:"Lisää vaakaviiva",
removeformat_desc:"Poista muotoilut",
forecolor_desc:"Valitse tekstin väri",
backcolor_desc:"Valitse tausta väri",
charmap_desc:"Lisää erikoismerkki",
visualaid_desc:"Vaihda suuntaviivat/näkymättömät elementit",
anchor_desc:"Lisää ankkuri / Ankkurin ominaisuudet",
cut_desc:"Leikkaa",
copy_desc:"Kopioi",
paste_desc:"Liitä",
...
help_desc:"Ohje",
blockquote_desc:"Lainaus (Alt+Shift+Q)",
clipboard_msg:"Kopioi/Leikkaa/Liitä -toiminto ei toimi Mozilla Firefoxissa.",
path:"Polku",
newdocument:"Haluatko poistaa kaiken sisällön?",
...
anchor_title:"Lisää ankkuri / Ankkurin ominaisuudet",
anchor_name:"Ankkurin nimi",
code_title:"HTML koodin muokkaus",
code_wordwrap:"automaattinen rivitys",
colorpicker_title:"Valitse väri",
colorpicker_picker_tab:"Valitsin",
colorpicker_picker_title:"Värivalitsin",
colorpicker_palette_tab:"Paletti",
colorpicker_palette_title:"Paletin värit",
colorpicker_named_tab:"Nimetyt",
colorpicker_named_title:"Nimetyt värit",
colorpicker_color:"Väri:",
colorpicker_name:"Nimi:",
charmap_title:"Valitse lisättävä merkki",
image_title:"Lisää kuva / Kuvan ominaisuudet",
image_src:"Kuvan URL",
image_alt:"Kuvaus",
image_list:"Kuvalista",
image_border:"Reuna",
image_dimensions:"Mitat",
image_vspace:"Välistys",
image_hspace:"Rivipituus",
image_align:"Asettelu",
image_align_baseline:"Perustasoon",
image_align_top:"Ylös",
image_align_middle:"Keskelle",
image_align_bottom:"Alas",
image_align_texttop:"Tekstin ylälaitaan",
image_align_textbottom:"Tekstin alalaitaan",
image_align_left:"Vasemmalle",
image_align_right:"Oikealle",
link_title:"Lisää linkki / Linkin ominaisuudet",
link_url:"Linkin URL",
link_target:"Kohde",
link_target_same:"Avaa linkki samassa ikkunassa",
link_target_blank:"Avaa linkki uudessa ikkunassa",
link_titlefield:"Otsikko",
link_is_email:"Antamasi osoite näyttää olevan sähköpostiosoite. Haluatko lisätä osoitteeseen vaaditun mailto: etuliitteen?",
link_is_external:"Syöttämäsi URL-osoite näyttäisi olevan linkki. Haluatko lisätä tarvittavan http:// etuliitteen?",
link_list:"Linkkilista"
});

tinyMCE.addI18n("fi.media_dlg",{
title:"Lisää upotettu media / Upotetun median ominaisuudet",
general:"Yleiset",
...
autostart:"Automaattinen toisto",
enabled:"Päällä",
...
defaultframe:"Current position",
playcount:"Current position",
rate:"Current position",
uimode:"Current position",
flash_options:"Flash -asetukset",
qt_options:"Quicktime asetukset",
wmp_options:"Windows media player:in asetukset",
rmp_options:"Real media player:in asetukset",
shockwave_options:"Shockwave asetukset",
autogotourl:"Auto goto URL",
center:"Keskelle",
imagestatus:"Auto goto URL",
maintainaspect:"Maintain aspect",
nojava:"Maintain aspect",
prefetch:"Maintain aspect",
shuffle:"Maintain aspect",
console:"Maintain aspect",
numloop:"Maintain aspect",
controls:"Ohjainlaitteet",
...
align_top:"Ylös",
align_right:"Oikealle",
align_bottom:"Alas",
align_left:"Vasemmalle",
align_center:"Keskelle",
align_top_left:"Ylävasemmalle",
align_top_right:"Yläoikealle",
align_bottom_left:"Alavasemmalle",
align_bottom_right:"Alaoikealle",
flv_options:"Flash videon asetukset",
flv_scalemode:"Scale mode",
flv_buffer:"Scale mode",
flv_startimage:"Scale mode",
flv_starttime:"Aloitus aika",
flv_defaultvolume:"Scale mode",
flv_hiddengui:"Scale mode",
flv_autostart:"Automaattinen toisto",
flv_loop:"Silmukka",
...
tinyMCE.addI18n("fi.wordpress",{
wp_adv_desc:"Näytä/Piilota lisäasetukset (Alt+Shift+Z)",
wp_more_desc:"Eroita ote (Alt+Shift+T)",
wp_page_desc:"Lisää sivunvaihto (Alt+Shift+P)",
wp_help_desc:"Ohje (Alt+Shift+H)",
wp_more_alt:"Lisää..",
wp_page_alt:"Seuraava sivu...",
add_media:"Lisää media",
add_image:"Lisää kuva",
add_video:"Lisää video",
add_audio:"Lisää ääni"
});

tinyMCE.addI18n("fi.wpeditimage",{
edit_img:"Muokkaa kuvaa",
del_img:"Poista kuva",
adv_settings:"Lisäasetukset",
none:"Ei mitään",
size:"Koko",
thumbnail:"Pienoiskuva",
medium:"Keskikokoinen",
full_size:"Täysikokoinen",
current_link:"Nykyinen linkki",
link_to_img:"Linkki kuvaan",
link_help:"Syötä linkin URL tai käytä alla olevia asetuksia",
adv_img_settings:"Kuvan lisäasetukset",
source:"Lähde",
width:"Leveys",
height:"Korkeus",
orig_size:"Alkuperäinen koko",
css:"CSS -luokka",
adv_link_settings:"Linkin lisäasetukset",
link_rel:"Linkin rel",
height:"Korkeus",
orig_size:"Alkuperäinen koko",
css:"CSS -luokka",
...
s120:"120%",
s130:"130%",
img_title:"Muokkaa kuvan otsikkoa",
caption:"Muokkaa otetta",
alt:"Muokkaa vaihtoehtoista tekstiä"
});
...
tinyMCE.init({mode:"none",onpageload:"wpEditorInit",width:"100%",theme:"advanced",skin:"wp_theme",theme_advanced_buttons1:"bold,italic,strikethrough,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,|,link,unlink,wp_more,|,spellchecker,fullscreen,wp_adv",theme_advanced_buttons2:"formatselect,underline,justifyfull,forecolor,|,pastetext,pasteword,removeformat,|,media,charmap,|,outdent,indent,|,undo,redo,wp_help",theme_advanced_buttons3:"",theme_advanced_buttons4:"",language:"fi",spellchecker_languages:"+English=en,Danish=da,Dutch=nl,Finnish=fi,French=fr,German=de,Italian=it,Polish=pl,Portuguese=pt,Spanish=es,Swedish=sv",theme_advanced_toolbar_location:"top",theme_advanced_toolbar_align:"left",theme_advanced_statusbar_location:"bottom",theme_advanced_resizing:"1",theme_advanced_resize_horizontal:"",dialog_type:"modal",relative_urls:"",remove_script_host:"",convert_urls:"",apply_source_formatting:"",remove_linebreaks:"1",paste_convert_middot_lists:"1",paste_remove_spans:"1",paste_remove_styles:"1",gecko_spellcheck:"1",entities:"38,amp,60,lt,62,gt",accessibility_focus:"",tab_focus:":next",content_css:"http://www.mahjongopas.info/wp-includes/js/tinymce/wordpress.css",save_callback:"switchEditors.saveCallback",wpeditimage_disable_captions:"",plugins:"safari,inlinepopups,autosave,spellchecker,paste,wordpress,media,fullscreen,wpeditimage"});